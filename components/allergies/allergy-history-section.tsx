 ...
 * `+ Log a change` button reads its onClick from AllergyLogChangeContext.
 * Clones condition-history-section.tsx — provider always present (no terminal
 * state), Show-all only when more than 5 changes, empty-history copy inline.
 */
export function AllergyHistorySection({
  totalCount,
  recentEntries,
  olderEntries,
}: Props) {
